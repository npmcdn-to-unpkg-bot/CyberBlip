function TableTimeStamp(selector) {
    /*
     * A Concrete Table widget used for the Timestamp portion of the Attack Table.
     *
     * @param selector: The DOM element selector representing this Table.
     */
    Table.call(this, selector);
}
TableTimeStamp.prototype = Object.create(Table.prototype); /* This is a Table widget */
